...
if (product) {
    ...
    document.getElementById('dynamic-breadcrumb').innerHTML = `
        ...
        <a href="category.html?type=${categoryKey}">${categoryKey.charAt(0).toUpperCase() + categoryKey.slice(1)}</a> > 
    ...
    `;
        ...
        if (btnBuyNow) {
            btnBuyNow.onclick = function() {
                ...
                window.location.href = `/ThongtinSP/order-information.html?id=${product.id}`;
            };
        }
